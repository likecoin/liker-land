<template>
  <div class="text-justify eula-page page-content text-gray-4a">
    ...
    <p>
      This EULA agreement governs your acquisition and use of our Liker Land
      software (“Software”) directly from oice Limited or indirectly through a
      oice Limited authorized reseller or distributor (a “Reseller”).
    </p>
    <p>
      Please read this EULA agreement carefully before completing the
      installation process and using the Liker Land software. It provides a
      license to use the Liker Land software and contains warranty information
      and liability disclaimers.
    </p>
    <p>
      If you register for a free trial of the Liker Land software, this EULA
      agreement will also govern that trial. By clicking “accept” or installing
      and/or using the Liker Land software, you are confirming your acceptance
    ...
    <p>
      This EULA agreement shall apply only to the Software supplied by oice
      Limited herewith regardless of whether other software is referred to or
    ...
    <h2>License Grant</h2>
    <p>
      oice Limited hereby grants you a personal, non-transferable, non-exclusive
      licence to use the Liker Land software on your devices in accordance with
      the terms of this EULA agreement.
    </p>
    <p>
      You are permitted to load the Liker Land software (for example a PC,
      laptop, mobile or tablet) under your control. You are responsible for
      ensuring your device meets the minimum requirements of the Liker Land
      software.
    </p>
    ...
    <ul>
      <li>
        ...
        software, nor decompile, disassemble or reverse engineer the Software or
      ...
      <li>
        use the Software for any purpose that oice Limited considers is a breach
        of this EULA agreement
      </li>
    </ul>
    <h2>Intellectual Property and Ownership</h2>
    <p>
      oice Limited shall at all times retain ownership of the Software as
      ...
      made thereto) are and shall remain the property of oice Limited.
    </p>
    <p>
      oice Limited reserves the right to grant licences to use the Software to
      third parties.
    </p>
    <h2>Termination</h2>
    <p>
      ...
      written notice to oice Limited.
    </p>
    <p>
