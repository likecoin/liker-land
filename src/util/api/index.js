...
export const getUserV2InteractedCreators = () => `/api/v2/users/interacted`;
...
export const postUserV2InteractedCreators = creator => {
  const qsPayload = { creator };
  return `/api/v2/users/interacted?${querystring.stringify(qsPayload)}`;
};
