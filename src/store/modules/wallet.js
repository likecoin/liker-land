...
import {
  ...
  WALLET_SET_INTERACTED_CREATORS,
...
const mutations = {
  ...
  [WALLET_SET_INTERACTED_CREATORS](state, interactedCreators) {
    state.interactedCreators = interactedCreators;
  },
...
const getters = {
  ...
  walletInteractedCreators: state => state.interactedCreators,
