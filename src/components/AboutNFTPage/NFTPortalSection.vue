    ...
    >
      ...
      >
        ...
        <image
          ...
          width="364"
          height="152"
          clip-path="url(#nft-portal-def-clip)"
        />
        <foreignObject x="306.61" y="231.19" width="332" height="40">
          <div class="text-[16px] leading-[20px] font-600">{{ title }}</div>
        </foreignObject>
        <foreignObject x="306.61" y="274.58" width="332" height="22">
          <div class="text-[16px] leading-[20px] text-[#4a4a4a]">
            {{ description }}
          </div>
        </foreignObject>
        <foreignObject x="306.61" y="338.35" width="73" height="22">
          <div>{{ priceLabel }}</div>
        </foreignObject>
        <rect
          x="477.61"
          ...
          fill="#aaf1e7"
        />
        <foreignObject x="477.61" y="329.35" width="161" height="40">
      ...
      <g class="nft-portal-graph__pointer" filter="url(#nft-portal-graph-blur)">
        <path
